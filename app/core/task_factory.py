    ...
    def create_synthesis_task(
        ...
        config = SynthesisConfig(
            ...
            rounded_style={
                ...
                "text_color": cfg.rounded_text_color.value,
                "cjk_font_name": cfg.rounded_cjk_font_name.value,
                "cjk_font_size": cfg.rounded_cjk_font_size.value,
                "cjk_text_color": cfg.rounded_cjk_text_color.value,
                "bg_color": cfg.rounded_bg_color.value,
                "corner_radius": cfg.rounded_corner_radius.value,
                "padding_h": cfg.rounded_padding_h.value,
                "padding_v": cfg.rounded_padding_v.value,
                "margin_bottom": cfg.rounded_margin_bottom.value,
                "line_spacing": cfg.rounded_line_spacing.value,
                "letter_spacing": cfg.rounded_letter_spacing.value,
            },
        )
